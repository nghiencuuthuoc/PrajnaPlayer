...
def load_state():
    if os.path.exists(STATE_FILE):
        try:
            ...
            # If JSON is invalid or unreadable, delete and start fresh
            try:
...
class PrajnaPlayerUI:
    def __init__(self):
        ...
        try:
            with open(os.path.join("title.txt"), "r", encoding="utf-8") as f:
        ...
        # self.sort_mode = tk.StringVar(value="Filename A-Z")
