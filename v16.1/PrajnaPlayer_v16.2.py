...
class PrajnaPlayerApp:
    def __init__(self, root: tk.Tk):
        ...
        # self.sort_mode = tk.StringVar(value=SORT_CHOICES[2]) # Modified
        self.sort_mode = tk.StringVar(value=SORT_CHOICES[2]) # A-Z
    ...
    def _build_bottom_filters_bar(self):
        ...
        self.sort_dropdown = ttk.Combobox(
            left, textvariable=self.sort_mode,
            values=SORT_CHOICES, width=22, state="readonly"
        )
        self.sort_dropdown.pack(side=tk.LEFT)

        # Ép giá trị khởi đầu là A→Z và hiển thị đúng mục
        self.sort_mode.set(SORT_CHOICES[0])      # "Title (A→Z)"
    ...
    def open_folder(self):
        ...
        self.sort_mode.set(SORT_CHOICES[0])   # đảm bảo A→Z
