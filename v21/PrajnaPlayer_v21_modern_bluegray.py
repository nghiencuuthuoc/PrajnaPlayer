...
BTN_PRIMARY = "#4F6D8A"
BTN_PRIMARY_ACTIVE = "#5F7D9A"
BTN_PRIMARY_PRESSED = "#425C74"
BTN_SECONDARY = "#D7E0EA"
BTN_SECONDARY_ACTIVE = "#E5EBF2"
BTN_SECONDARY_PRESSED = "#C5D0DD"
BTN_ACCENT = "#6B8AA8"
BTN_ACCENT_ACTIVE = "#7A98B5"
BTN_ACCENT_PRESSED = "#587590"
BTN_ACTIVE = "#2F7D6B"
BTN_ACTIVE_HOVER = "#3A9380"
BTN_ACTIVE_PRESSED = "#28685A"
BTN_SYSTEM = "#4B5563"
BTN_SYSTEM_ACTIVE = "#5B6675"
BTN_SYSTEM_PRESSED = "#3F4753"
...
def apply_pharmapp_theme(root: tk.Tk):
    ...
    s.map("Treeview", background=[("selected", "#C6D4E1")], foreground=[("selected", FG)])
...
class PrajnaPlayerApp:
    def __init__(self, root: tk.Tk):
        ...
        self.base_title = "v21_modern_bluegray"
    ...
    def _build_dock_shell(self):
        ...
        self.toolbar_host = ttk.Frame(self.app_shell)
        self.toolbar_host.grid(row=0, column=0, sticky="ew")

        self.top_panel_host = ttk.Frame(self.app_shell)
        self.top_panel_host.grid(row=1, column=0, sticky="ew")
    ...
    def _build_toggle_toolbar(self):
        bar = ttk.Frame(self.toolbar_host)
        ...
        self.btn_reset_panels = ttk.Button(bar, text="Reset Layout", style="PanelToggle.TButton", command=self.reset_panel_layout)
    ...
    def _build_hero_paned(self, parent=None):
        ...
        self.hero.pack(fill=tk.BOTH, expand=True, padx=6, pady=(4, 4))
